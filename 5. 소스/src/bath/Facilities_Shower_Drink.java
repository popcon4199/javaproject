...
public class Facilities_Shower_Drink {
	...
	private static void showerdrink(String menu, BufferedReader reader2,int price) throws IOException {
		...
		System.out.println();
		System.out.printf("선택하신 음료는 '%s', 수량은 %d개 입니다.\n" + "이대로 계속하시겠습니까?(y/n) : ", menu, number);
